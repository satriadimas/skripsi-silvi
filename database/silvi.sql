...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2022 at 01:25 PM
...
CREATE TABLE `table_penyewaan` (
  ...
  `bukti_pembayaran` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `table_penyewaan` (`id`, `user_id`, `tanggal`, `jumlah_pengunjung`, `created_at`, `updated_at`, `status`, `peminjaman`, `kegiatan`, `disetujui_oleh`, `biaya`, `bukti_pembayaran`) VALUES
(5, 7, '2022-06-27', '15', '2022-06-25 11:15:15', '2022-06-25 12:46:18', 4, '2', 'Pernikahan dengan Berliana  Pancarani', 8, '1000000', '5.png');
